...
public class GraphicRelativitySimulator extends JFrame {
    ...
    private JPanel createAboutPane() {
        ...
        JLabel nameLabel = new JLabel("Made by: Yixian Cheng");
        ...
        personalInfoPanel.add(createLabelAndURL("LinkedIn",
                "https://www.linkedin.com/in/yixian-cheng-899b92187/",
                "https://www.linkedin.com/in/yixian-cheng-899b92187/"));
        ...
        specialThanksModel.addElement("Mr. Frank Zhang & Ms. Annie Geng");
        specialThanksModel.addElement("Mr. Martin Xu");
        specialThanksModel.addElement("Prof. Janis Mckenna");
        specialThanksModel.addElement("Prof. Ian Affleck");
        specialThanksModel.addElement("Dr. Harris Nelson");
        specialThanksModel.addElement("Mr. Charles Zhang");
        specialThanksModel.addElement("Mr. Theo Johnson");
        specialThanksModel.addElement("Mr. Farhad Sadat");
        specialThanksModel.addElement("Mr. Zeidoon Nashi");
        specialThanksModel.addElement("Ms. Xia Wang");
        specialThanksModel.addElement("Mr. Jilin Mao");
        specialThanksModel.addElement("Mr. Evan Lemay");
        specialThanksModel.addElement("Mr. Garry Bergquist");
        specialThanksModel.addElement("Ms. Gendi Xu");
        specialThanksModel.addElement("Mr. Yuxin Lu");
        specialThanksModel.addElement("Ms. Ling Xu");
        specialThanksModel.addElement("Mr. Weifeng Xu");
